...
# Suleman Manji
A proficient IT consultant specializing in cloud services, privileged access management, automation, and leveraging technology to augment human endeavors. Holding a Bachelor’s degree in Management of Information Systems from the University of Houston's Bauer School of Business, I blend academic insights with extensive practical experience. An inquisitive researcher, I enjoy exploring science documentaries and innovative engineering methodologies.
...
- **Architectural Rectification:** Addressed architectural bottlenecks in .NET C# Blazor Server application, proposing an optimization roadmap that enhanced system resilience.
- **Azure-Powered Monitoring:** Integrated Azure monitoring tools for real-time insights, speeding up error identification and rectification, thus reducing system downtime.
- **Hosting & Infrastructure Optimization:** Strategized on Azure-hosted infrastructure parameters to achieve a significant 40% reduction in hosting costs within months.
- **Revamped Deployment Workflows:** Led the establishment of CI/CD processes using Azure DevOps, ensuring seamless and error-free deployments.
- **Application Efficiency:** Enhanced overall application performance through app registration consolidation within Azure.
- **Quality Assurance & Load Testing:** Implemented rigorous load testing measures using Azure-based tools and .NET C# Blazor Server expertise, validating system's real-world traffic handling capability.
- **Error Management & Reduction:** Addressed system errors, notably daily Server 500 errors, improving system stability and user experience.
- **Scalability Revisions:** Proactively tweaked application architecture for better scalability in anticipation of future growth and system demands.

### **Fulcrum Technology (FTSC) - Various Projects**
#### **Technical SME/Architect, Engineer, Project Manager, and Junior Engineer Roles**

#### **Project: CyberArk Endpoint Privileges Management for McKesson - USA**
- Conducted policy reconciliation, optimization, and agent upgrades for the CyberArk Endpoint Management system.
- Collaborated closely with Application and Operational Support teams to ensure streamlined operations.

#### **Project: CorePAS Azure Deployment for McKesson - UK/Ireland**
- Played a key role in GDPR compliance efforts, managing data migration to appropriate Azure resources.
- Maintained system parity across Enterprise Active Directory Domain Implementations.

#### **Project: VMWare Security Posture Reporting for McKesson - UK/Ireland/Canada/USA**
- Designed a robust security posture reporting system for VMware using vCenter and PowerShell.
- Utilized CIS Level Compliance as standard compliance indicators, relaying the status to a Splunk collector(s).

#### **Project: CyberArk PrivilegeCloud PAM Implementation for Exterran**
- Led the transition from KeePass to CyberArk PrivilegeCloud for managing Privileged Accesses.
- Developed internal privileged access processes, migrated secrets data, and initiated an automated credential rotation program for priority Active Directory accounts.

#### **Project: Ransomware Incident Response for Tri-Supply**
- Instrumental in a comprehensive ransomware incident response, including the rebuilding of the Active Directory domain.
- Coordinated with other Architects, Engineers, and Executives for domain and network infrastructure rebuilding, as well as server and workstation re-imaging.
- Implemented CortexEDR, TaniumXDR, and Standard Policies to bolster IT security measures moving forward.

#### **Project: Directory Services for Texas Children's Hospital**
- Architected and implemented shared Azure Global Administrator accesses using PowerShell.
- Utilized technologies like ServiceNOW, PowerShell, and hybrid Azure Active Directory infrastructure to optimize directory services alongside a Remote Team of eight.

#### **Project: Vendor Selection for CommScope**
